// Ported from simulador-subastas-peru; restyled onto the --pd-* token layer
// via theme.ts (same export shape there, values now CSS vars).
  ...
  return (
    <label style={{ display: 'block', marginBottom: space.md }}>
      <div style={{ display: 'flex', justifyContent: 'space-between', fontSize: 13, marginBottom: 4 }}>
        ...
        <span style={{ color: colors.accent.blue, fontWeight: 700, fontFamily: 'var(--pd-font-mono)' }}>
