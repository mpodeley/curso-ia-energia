import{j as e,L as C,c as s,F as A,b as T,s as l,S as w,a as y,r as D}from"./index-CSdcDKjC.js";import{i as k,a as I,E as M,S as E}from"./useExerciseState-CUdvPr5l.js";function F(o,a){let m=0,f=0,g=0,u=0;o.forEach((c,q)=>{const x=c.inventada===!0,d=a.has(q);x&&u++,x&&d&&m++,!x&&d&&f++,x&&!d&&g++});const p=m+f,h=p===0?0:m/p,i=u===0?0:m/u,t=h+i===0?0:2*h*i/(h+i);return{encontradas:m,falsasAlarmas:f,perdidas:g,totalInventadas:u,precision:h,recall:i,f1:t}}function P(o){return o.totalInventadas===0?"No había nada que encontrar.":o.encontradas===o.totalInventadas&&o.falsasAlarmas===0?"Las encontraste todas y no marcaste ninguna afirmación sana. Eso es leer con criterio.":o.encontradas===0?"No marcaste ninguna de las invenciones. Fijate abajo qué las delataba: casi siempre es una cifra muy precisa sin fuente.":o.precision<.5?"Marcaste más afirmaciones sanas que invenciones. Desconfiar de todo cuesta tanto tiempo como no desconfiar de nada, y encima no deja lugar para la duda cuando hace falta.":o.encontradas===o.totalInventadas?"Encontraste todas las invenciones, pero te llevaste puestas algunas afirmaciones correctas.":"Encontraste algunas. Las que se te escaparon son las más peligrosas, porque son las que pasarían una revisión."}function N({sesion:o=7}){const{data:a,meta:m,loading:f,error:g}=k(),[u,p,h]=I("hallucination-hunt",{informe:"",marcados:{},corregidos:[]});if(f)return e.jsx(C,{what:"los informes"});if(g||!a||a.length===0)return e.jsx("div",{style:{color:s.status.err},children:"No se pudieron cargar los informes."});const i=a.find(n=>n.id===u.informe)??a[0],t=new Set(u.marcados[i.id]??[]),c=u.corregidos.includes(i.id),q=n=>{if(c)return;const r=new Set(t);r.has(n)?r.delete(n):r.add(n),p({marcados:{...u.marcados,[i.id]:[...r]}})},x=()=>p({corregidos:[...u.corregidos,i.id]}),d=F(i.segmentos,t),z=n=>{const r=i.segmentos[n],b=t.has(n);let j=s.border,v="transparent";return c?r.inventada&&b?(j=s.status.ok,v=s.status.ok+"12"):r.inventada&&!b?(j=s.status.err,v=s.status.err+"12"):!r.inventada&&b&&(j=s.status.warn,v=s.status.warn+"12"):b&&(j=s.accent.blue,v=s.accent.blue+"12"),{display:"block",width:"100%",textAlign:"left",font:"inherit",fontSize:"var(--pd-fs-sm)",color:s.textPrimary,lineHeight:1.6,padding:`${l.sm}px ${l.md}px`,marginBottom:l.sm,border:`1px solid ${j}`,borderLeftWidth:3,borderRadius:D.md,background:v,cursor:c?"default":"pointer"}},L=n=>{const r=i.segmentos[n];return c?r.inventada&&t.has(n)?"inventada — la encontraste":r.inventada?"inventada — se te pasó":t.has(n)?"era correcta — falsa alarma":"correcta":t.has(n)?"marcada":""},$=n=>{const r=i.segmentos[n];return c?r.inventada&&t.has(n)?s.status.ok:r.inventada?s.status.err:t.has(n)?s.status.warn:s.textDim:s.accent.blue};return e.jsxs(M,{titulo:"Cacería de alucinaciones",sesion:o,intro:"Tres textos generados por un modelo. Algunas afirmaciones son sólidas y otras están inventadas con total seguridad. Marcá las que no usarías sin verificar antes — y ojo, marcar todo no cuenta como acertar.",onReset:h,done:c,children:[e.jsx(A,{label:"Informe",children:e.jsx(T,{value:i.id,options:a.map(n=>({value:n.id,label:n.label})),onChange:n=>p({informe:n})})}),e.jsx("p",{style:{fontSize:"var(--pd-fs-sm)",color:s.textSecondary,margin:`0 0 ${l.lg}px`,maxWidth:"70ch"},children:i.contexto}),i.segmentos.map((n,r)=>e.jsxs("div",{children:[e.jsx("button",{type:"button",style:z(r),onClick:()=>q(r),disabled:c,children:n.texto}),(c||t.has(r))&&e.jsx("div",{style:{fontFamily:"var(--pd-font-mono)",fontSize:11,textTransform:"uppercase",letterSpacing:.5,color:$(r),margin:`-4px 0 ${l.sm}px ${l.md}px`},children:L(r)}),c&&e.jsxs("div",{style:{margin:`0 0 ${l.lg}px ${l.md}px`,maxWidth:"70ch"},children:[e.jsx("p",{style:{fontSize:13,color:s.textSecondary,margin:0},children:n.porque}),n.comoVerificar&&e.jsxs("p",{style:{fontSize:13,color:s.textPrimary,margin:`${l.xs}px 0 0`},children:[e.jsx("strong",{children:"Cómo verificarlo:"})," ",n.comoVerificar]})]})]},r)),c?e.jsxs(e.Fragment,{children:[e.jsx("div",{style:{margin:`${l.lg}px 0`},children:e.jsxs(w,{children:[e.jsx(y,{label:"Encontradas",value:`${d.encontradas} / ${d.totalInventadas}`,accent:d.encontradas===d.totalInventadas?s.status.ok:s.status.err}),e.jsx(y,{label:"Falsas alarmas",value:d.falsasAlarmas,accent:d.falsasAlarmas===0?s.status.ok:s.status.warn,hint:"Afirmaciones correctas que marcaste como sospechosas"}),e.jsx(y,{label:"Precisión",value:`${Math.round(d.precision*100)}%`,hint:"De todo lo que marcaste, cuánto estaba realmente mal"})]})}),e.jsx("p",{style:{fontSize:"var(--pd-fs-sm)",color:s.textPrimary,maxWidth:"70ch"},children:P(d)}),i.note&&e.jsx(E,{titulo:"El patrón detrás de este informe",children:i.note})]}):e.jsxs("div",{style:{display:"flex",gap:l.md,alignItems:"center",flexWrap:"wrap",marginTop:l.lg},children:[e.jsx("button",{type:"button",className:"btn btn--primary",disabled:t.size===0,onClick:x,children:"Corregir"}),e.jsx("span",{style:{fontSize:13,color:s.textMuted},children:t.size===0?"Marcá al menos una afirmación.":`${t.size} marcada${t.size>1?"s":""} de ${i.segmentos.length}.`})]}),e.jsx(E,{titulo:"El protocolo, en cuatro preguntas",children:"Es lo que te llevás de esta sesión, más que el puntaje. Ante cualquier afirmación de un modelo, preguntate: ¿esto se puede derivar de lo que le di, o lo completó por su cuenta? ¿Qué fuente primaria lo confirmaría, y cuánto tardo en abrirla? ¿Qué pasa si es falso y nadie lo nota? Y la más útil: ¿por qué sonaba creíble? Las invenciones peligrosas no son las absurdas, son las que tienen la forma exacta de un dato verdadero."}),e.jsx(E,{titulo:"Por qué marcar todo tampoco sirve",children:"Si desconfiás de cada frase, la herramienta deja de ahorrarte tiempo y volvés a escribir todo a mano. El objetivo no es la desconfianza, es la puntería: saber qué clase de afirmación exige fuente. Las cifras que salen de datos que vos entregaste casi siempre están bien; las causas, las citas, la normativa y las estimaciones de beneficio casi nunca."}),m.source&&e.jsxs("div",{style:{marginTop:l.md,fontFamily:"var(--pd-font-mono)",fontSize:"var(--pd-fs-cap)",color:s.textDim},children:["fuente: ",m.source]})]})}function S(o){const a={em:"em",h2:"h2",li:"li",ol:"ol",p:"p",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",ul:"ul",...o.components};return e.jsxs(e.Fragment,{children:[e.jsx(a.h2,{children:"Antes de la sesión"}),`
...
segunda pregunta es la difícil.`})]})}function W(o={}){const{wrapper:a}=o.components||{};return a?e.jsx(a,{...o,children:e.jsx(S,{...o})}):S(o)}export{W as default};
