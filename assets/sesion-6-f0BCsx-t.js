import{j as e,L as z,c as n,s,r as x,a as E,b as g}from"./index-CfQ8CGuP.js";import{g as S,a as T,E as A,S as h,R as M,Q as P}from"./Recursos-kAW3c6BC.js";const R={bash:"terminal",python:"python",respuesta:"respuesta final"};function C(o,a){return o.slice(0,a+1).reduce((d,l)=>d+l.pensamiento.length+l.entrada.length+l.salida.length,0)}const v={fontFamily:"var(--pd-font-mono)",fontSize:13,whiteSpace:"pre-wrap",overflowX:"auto",background:n.surface,border:`1px solid ${n.border}`,borderRadius:x.md,padding:s.md,margin:0};function D({sesion:o=6}){const{data:a,meta:d,loading:l,error:f}=S(),[y,m,q]=T("agent-trace",{paso:0});if(l)return e.jsx(z,{what:"la traza"});if(f||!a||a.pasos.length===0)return e.jsx("div",{style:{color:n.status.err},children:"No se pudo cargar la traza."});const c=a.pasos.length,r=Math.min(Math.max(y.paso,0),c-1),i=a.pasos[r],u=i.estado==="error",j=i.herramienta==="respuesta";return e.jsxs(A,{titulo:"El loop por dentro",sesion:o,intro:"Un agente no es magia: es un modelo que piensa, ejecuta una herramienta, mira el resultado y vuelve a pensar. Recorré la traza paso a paso y mirá la mecánica, incluido el momento en que se equivoca.",onReset:q,children:[e.jsxs("div",{style:{background:n.surface,border:`1px solid ${n.border}`,borderRadius:x.md,padding:s.md,marginBottom:s.lg},children:[e.jsx("div",{style:{fontSize:12,color:n.textDim,fontFamily:"var(--pd-font-mono)",textTransform:"uppercase",letterSpacing:.5},children:"Lo que le pidieron"}),e.jsx("div",{style:{fontSize:"var(--pd-fs-sm)",color:n.textPrimary,marginTop:4},children:a.objetivo})]}),e.jsx("div",{style:{display:"flex",gap:4,flexWrap:"wrap",marginBottom:s.lg},children:a.pasos.map((p,t)=>e.jsx("button",{type:"button",title:p.pensamiento.slice(0,80),onClick:()=>m({paso:t}),style:{font:"inherit",fontFamily:"var(--pd-font-mono)",fontSize:12,width:30,height:30,borderRadius:x.sm,cursor:"pointer",border:`1px solid ${t===r?n.accent.blue:p.estado==="error"?n.status.err:n.border}`,background:t===r?n.accent.blue+"15":t<r?n.surfaceAlt:n.surface,color:t===r?n.accent.blue:p.estado==="error"?n.status.err:n.textMuted,fontWeight:t===r?700:400},children:t+1},t))}),e.jsxs("div",{style:{display:"flex",gap:s.sm,alignItems:"center",marginBottom:s.lg,flexWrap:"wrap"},children:[e.jsx("button",{type:"button",className:"tbtn",disabled:r===0,onClick:()=>m({paso:r-1}),children:"← Anterior"}),e.jsx("button",{type:"button",className:"tbtn",disabled:r===c-1,onClick:()=>m({paso:r+1}),children:"Siguiente →"}),e.jsxs("span",{style:{fontSize:13,color:n.textMuted},children:["Paso ",r+1," de ",c]})]}),e.jsxs("div",{style:{marginBottom:s.md},children:[e.jsx("div",{style:{fontSize:12,color:n.textDim,fontFamily:"var(--pd-font-mono)",textTransform:"uppercase",letterSpacing:.5,marginBottom:4},children:"Piensa"}),e.jsx("p",{style:{margin:0,fontSize:"var(--pd-fs-sm)",color:n.textPrimary,maxWidth:"70ch"},children:i.pensamiento})]}),!j&&e.jsxs("div",{style:{marginBottom:s.md},children:[e.jsxs("div",{style:{fontSize:12,color:n.textDim,fontFamily:"var(--pd-font-mono)",textTransform:"uppercase",letterSpacing:.5,marginBottom:4},children:["Ejecuta · ",R[i.herramienta]]}),e.jsx("pre",{style:v,children:i.entrada})]}),e.jsxs("div",{children:[e.jsx("div",{style:{fontSize:12,color:u?n.status.err:n.textDim,fontFamily:"var(--pd-font-mono)",textTransform:"uppercase",letterSpacing:.5,marginBottom:4},children:j?"Responde":u?"Observa — no era lo que esperaba":"Observa"}),e.jsx("pre",{style:{...v,borderColor:u?n.status.err:n.border},children:i.salida})]}),u&&e.jsx("p",{style:{fontSize:"var(--pd-fs-sm)",color:n.status.err,marginTop:s.md,maxWidth:"70ch"},children:"Acá el agente se equivocó: dio por sentado cómo se escribía el nombre del área. Fijate en el paso siguiente qué hace con el error — no vuelve a adivinar, va a mirar los datos."}),e.jsx("div",{style:{marginTop:s.lg},children:e.jsxs(E,{children:[e.jsx(g,{label:"Paso",value:`${r+1} / ${c}`,hint:"Cada paso es una vuelta completa del loop"}),e.jsx(g,{label:"Contexto acumulado",value:C(a.pasos,r).toLocaleString("en-US"),unit:"caracteres",hint:"Todo lo anterior viaja en cada llamada. Por eso los agentes se vuelven lentos y caros en tareas largas."})]})}),e.jsxs(h,{titulo:"El loop, en una línea",children:["Objetivo → pensar qué falta → elegir una herramienta → ejecutarla → mirar el resultado → repetir hasta poder responder. Eso es todo. Lo único que agrega el agente sobre un chatbot es la capacidad de ",e.jsx("em",{children:"ejecutar"})," y de ",e.jsx("em",{children:"mirar lo que salió"}),", y esa diferencia es la que lo vuelve útil y la que lo vuelve riesgoso."]}),e.jsx(h,{titulo:"Qué mirar en esta traza",children:"Tres cosas. Primero, el agente no arranca escribiendo código: arranca mirando qué hay. Segundo, cuando el filtro devuelve cero no insiste ni inventa un resultado — va a buscar los valores reales y encuentra que el área lleva diéresis. Tercero, en la respuesta final aclara qué no verificó. Un agente que no puede ejecutar nunca se entera de que se equivocó; este se entera porque el resultado vuelve."}),e.jsx(h,{titulo:"Dónde esto se vuelve peligroso",children:"Todo lo que hace este agente es reversible: lee archivos y escribe un gráfico. El problema aparece cuando las herramientas dejan de ser de lectura — mandar un correo, cerrar una válvula, escribir en un sistema de control. El loop es el mismo, pero un paso equivocado ya no se corrige mirando la salida. De eso va la sesión 7."}),d.source&&e.jsxs("div",{style:{marginTop:s.md,fontFamily:"var(--pd-font-mono)",fontSize:"var(--pd-fs-cap)",color:n.textDim},children:["fuente: ",d.source]})]})}function b(o){const a={em:"em",h2:"h2",li:"li",ol:"ol",p:"p",strong:"strong",table:"table",tbody:"tbody",td:"td",th:"th",thead:"thead",tr:"tr",...o.components};return e.jsxs(e.Fragment,{children:[e.jsx(a.h2,{children:"Antes de la sesión"}),`
...
`,e.jsxs(a.table,{children:[e.jsx(a.thead,{children:e.jsxs(a.tr,{children:[e.jsx(a.th,{children:"Bloque"}),e.jsx(a.th,{children:"Tiempo"}),e.jsx(a.th,{children:"Qué hacemos"})]})}),e.jsxs(a.tbody,{children:[e.jsxs(a.tr,{children:[e.jsx(a.td,{children:"El loop, en vivo"}),e.jsx(a.td,{children:"30 min"}),e.jsx(a.td,{children:"Un agente real trabajando sobre datos de la industria, de punta a punta"})]}),e.jsxs(a.tr,{children:[e.jsx(a.td,{children:"Sus tareas"}),e.jsx(a.td,{children:"40 min"}),e.jsx(a.td,{children:"Tomamos las cadenas de pasos que trajeron y marcamos qué tramo delegaría hoy y cuál no"})]}),e.jsxs(a.tr,{children:[e.jsx(a.td,{children:"Dónde se rompe"}),e.jsx(a.td,{children:"25 min"}),e.jsx(a.td,{children:"Contexto que crece, objetivos que se pierden, herramientas que no deberían estar"})]}),e.jsxs(a.tr,{children:[e.jsx(a.td,{children:"Puente a la sesión 7"}),e.jsx(a.td,{children:"15 min"}),e.jsx(a.td,{children:"Qué cambia cuando las herramientas dejan de ser de solo lectura"})]}),e.jsxs(a.tr,{children:[e.jsx(a.td,{children:"Cierre y tarea"}),e.jsx(a.td,{children:"10 min"}),e.jsx(a.td,{children:"La tarea de la sesión 7"})]})]})]}),`
`,e.jsx(P,{data:"quiz_s6",sesion:6}),`
...
de lo que le di? Marcá una. Traela a la sesión 7, sin decir todavía si estaba bien o mal.`})]})}function U(o={}){const{wrapper:a}=o.components||{};return a?e.jsx(a,{...o,children:e.jsx(b,{...o})}):b(o)}export{U as default};
